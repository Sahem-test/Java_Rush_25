package main.java.core.level08.task137;

/**
 * Личное приветствие для нового пользователя 👋
 * Представьте, что вы создаете интерактивное приложение, которое стремится лично приветствовать каждого своего нового пользователя, делая его визит по-настоящему особенным.
 * Ваша задача — написать специальную функцию, которая будет обращаться к человеку по имени, создавая ощущение индивидуального подхода.
 * Создайте класс PersonalGreeter.
 * Внутри него объявите статический метод welcomeNewUser,
 * который будет принимать в качестве единственного параметра userName — это строка, содержащая имя пользователя.
 * Этот метод должен формировать и выводить на экран дружелюбную фразу, начинающуюся с "Приветствуем тебя, " и сразу же добавлять к ней переданное имя пользователя.
