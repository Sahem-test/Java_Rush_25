package main.java.core.level08.task138;

/**
 * Быстрый подсчет стоимости покупки 💰
 * Вообразите, что вы работаете кассиром в небольшом, но очень оживленном магазине, и вам нужен быстрый способ подсчета общей стоимости двух товаров, чтобы не заставлять покупателей ждать.
