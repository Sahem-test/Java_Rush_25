package main.java.core.level08.task139;

/**
 * Создание карточки сотрудника для отдела кадров 👩‍💻
 * Представьте, что вы создаете автоматизированную систему для ведения карточек сотрудников в отделе кадров.
 * Каждая карточка должна четко отображать основную информацию о человеке, комбинируя разные типы данных.
 * Создайте класс HRProfileManager. Внутри этого класса объявите статический метод displayEmployeeCard,
 * который будет принимать два параметра: employeeName (строку с полным именем сотрудника) и employeeAge (целое число, его возраст).
