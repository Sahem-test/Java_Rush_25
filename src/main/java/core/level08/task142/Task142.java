package main.java.core.level08.task142;

/**
 * Детектор четности для игровой викторины ❓
 * Вообразите, что вы программируете обучающую игру-викторину, которая помогает детям освоить понятия четных и нечетных чисел.
 * Вашему игровому движку необходим быстрый и надежный способ проверять это свойство любого числа.
...
public class Task142 {
    public static void main(String[] args) {
        String result = Solution.checkIfEven(18) ? "Это число чётное!" : "Это число нечётное!";
