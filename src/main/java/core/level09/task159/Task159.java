package main.java.core.level09.task159;

/**
 * Форматирование таблицы с выравниванием
 * Вы создаёте систему складского учёта для большого супермаркета.
 * Каждый день нужно печатать отчёты о поступлении товаров, и крайне важно,
 * чтобы все данные — название товара, количество и вес — были аккуратно выровнены в колонках, создавая чёткую и легко читаемую таблицу, даже если это всего одна строка.
 ...
 * Затем, используя String.format, сформируйте и выведите на консоль строку, которая будет выглядеть как идеальная строка отчёта:
 * название товара выровнено влево и занимает 10 символов, количество — вправо и 4 символа, а вес отображается с двумя знаками после запятой, занимая 5 символов.
 * Примерно так: "Товар: [Яблоки ] | Кол-во: [ 7] | Вес: [ 1.23 кг]".
 * Требования:
